...
class SitemapSpider(CrawlSpider):
    ...
    name = 'sitemap'
    seedfile = 'sitemap_seeds.txt'

    start_urls = [
        "https://www.proofpoint.com/us/sitemap.xml",
        "https://securelist.com/sitemap.xml",
        "https://www.sentinelone.com/sitemap_index.xml",
        "https://blog.malwarebytes.com/sitemap.xml",
        "https://www.mandiant.com/sitemap.xml",
        "https://www.crowdstrike.com/sitemap_index.xml",
        "https://www.netscout.com/default/sitemap.xml",
        "https://www.clearskysec.com/wp-sitemap.xml"
    ]
    ...
    def __init__(self, *a, **kw):
        ...
        with open('sitemap_seeds.txt') as f:
