...
__VERSION__ = "20220722161405_3179B2"

__module_path = os.path.abspath(os.path.dirname(__file__))

PyTorchPageClassPredicition = saved_bundle.load_bento_service_class(__module_path)
...
__all__ = ['__version__', 'PyTorchPageClassPredicition', 'load']
