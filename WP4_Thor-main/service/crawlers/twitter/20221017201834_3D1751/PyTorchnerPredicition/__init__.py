...
__VERSION__ = "20221017201834_3D1751"

__module_path = os.path.abspath(os.path.dirname(__file__))

PyTorchnerPredicition = saved_bundle.load_bento_service_class(__module_path)
...
__all__ = ['__version__', 'PyTorchnerPredicition', 'load']
