...
__VERSION__ = "20220523165127_E8A2B3"

__module_path = os.path.abspath(os.path.dirname(__file__))

Tweet_classification = saved_bundle.load_bento_service_class(__module_path)
...
__all__ = ['__version__', 'Tweet_classification', 'load']
