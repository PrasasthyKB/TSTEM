...
setuptools.setup(
    ...
    version='20220523165127_E8A2B3',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - Tweet_classification:20220523165127_E8A2B3
...
""",
    ...
    package_data={
        'Tweet_classification': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'Tweet_classification=Tweet_classification:cli',
        ],
    }
)
